 ...
 */
public abstract class CameraBridgeViewBase implements SurfaceHolder.Callback {
    ...
    protected boolean mCameraPermissionGranted = true;
...
//        styledAttrs.recycle();
    ...
    private void checkCurrentState() {
        ...
        int targetState;
        if (mEnabled && mCameraPermissionGranted) {
            targetState = STARTED;
        } else {
            targetState = STOPPED;
        }
     ...
     *
     */
    protected abstract boolean connectCamera();
